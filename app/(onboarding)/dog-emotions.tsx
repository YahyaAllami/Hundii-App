...
const emotionalProblems = [
  { id: 'separation', label: 'Trennungsangst', emoji: '😢' },
  { id: 'noise', label: 'Angst vor Geräuschen', emoji: '💥' },
  { id: 'dogs', label: 'Angst vor anderen Hunden', emoji: '🐶' },
  { id: 'strangers', label: 'Angst vor Fremden', emoji: '👤' },
  { id: 'anxiety', label: 'Allgemeine Ängstlichkeit', emoji: '😰' },
  { id: 'reactivity', label: 'Reaktivität / Aggression', emoji: '⚡' },
  { id: 'guarding', label: 'Ressourcenverteidigung', emoji: '🦷' },
  { id: 'hyperactive', label: 'Hyperaktivität', emoji: '🌪️' },
];

export default function DogEmotionsScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.progressText}>Schritt 5 von 5</Text>
      </Animated.View>
